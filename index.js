...
// ---------- Database Collections (Global) ----------
let UserCollection, FoodsCollection, CartCollection, OrdersCollection;
...
// ---------- API Middleware to ensure DB connection ----------
...
app.get('/users/email/:email', ensureDbConnection, async (req, res) => {
  try {
...
app.put('/users/:id', ensureDbConnection, async (req, res) => {
  try {
...
app.delete('/users/:id', ensureDbConnection, async (req, res) => {
  try {
    const id = req.params.id;
    const query = { _id: new ObjectId(id) };
...
// ---------- Foods APIs ----------
app.get('/foods', ensureDbConnection, async (req, res) => {
  try {
...
app.post('/foods', ensureDbConnection, async (req, res) => {
  try {
    const food = req.body;
...
app.delete('/foods/:id', ensureDbConnection, async (req, res) => {
  try {
    const id = req.params.id;
    const query = { _id: new ObjectId(id) };
...
app.put('/foods/:id', ensureDbConnection, async (req, res) => {
  try {
    const id = req.params.id;
...
// ---------- Cart APIs ----------
app.post('/cart', ensureDbConnection, async (req, res) => {
  try {
...
app.get('/cart', ensureDbConnection, async (req, res) => {
  try {
...
app.get('/cart/:email', ensureDbConnection, async (req, res) => {
  try {
    const email = req.params.email;
...
app.delete('/cart/:email', ensureDbConnection, async (req, res) => {
  try {
    const email = req.params.email;
...
app.delete('/cart/:email/item/:itemId', ensureDbConnection, async (req, res) => {
  try {
    const email = req.params.email;
...
// ---------- Orders APIs ----------
app.post('/orders', ensureDbConnection, async (req, res) => {
  try {
    const orderData = {
...
app.get('/orders', ensureDbConnection, async (req, res) => {
  try {
...
app.get('/orders/check/:orderId', ensureDbConnection, async (req, res) => {
  try {
...
app.put('/orders/status/:orderId', ensureDbConnection, async (req, res) => {
  try {
    const orderId = req.params.orderId;
...
app.put('/orders/:id', ensureDbConnection, async (req, res) => {
  try {
    const id = req.params.id;
...
app.put('/orders/status-update/:id', ensureDbConnection, async (req, res) => {
  try {
    const id = req.params.id;
    const { status } = req.body;
...
app.get('/orders/:email', ensureDbConnection, async (req, res) => {
  try {
    const email = req.params.email;
...
app.delete('/orders/:id', ensureDbConnection, async (req, res) => {
  try {
    const id = req.params.id;
...
app.put('/orders/:orderId/item/:itemId/decrease', ensureDbConnection, async (req, res) => {
  try {
    const orderId = req.params.orderId;
    const itemId = req.params.itemId;
...
app.delete('/orders/:orderId/item/:itemId', ensureDbConnection, async (req, res) => {
  try {
    const orderId = req.params.orderId;
    const itemId = req.params.itemId;
...
// ---------- Payment APIs ----------
app.post('/create-payment-v2', ensureDbConnection, async (req, res) => {
  try {
...
app.post('/payment-notify', ensureDbConnection, async (req, res) => {
  try {
